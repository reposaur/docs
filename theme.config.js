export default {
  github: 'https://github.com/reposaur/reposaur',
  docsRepositoryBase: 'https://github.com/reposaur/docs/blob/main',
  titleSuffix: ' – Reposaur',
  logo: (
    <>
      <span className="mr-2 font-extrabold hidden md:inline">Reposaur</span>
      <span className="text-gray-600 font-normal hidden md:inline">
        Security & Compliance for GitHub Organizations
      </span>
    </>
  ),
  head: (
